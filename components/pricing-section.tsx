  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Perfect for individuals starting their backend journey.",
      features: [
        "Basic backend question library",
        "Progress tracking dashboard",
        "Mock authentication practice",
        "Up to 10 practice assignments",
    ...
    },
    {
      ...
      monthlyPrice: "$20",
      annualPrice: "$16",
      description: "Ideal for serious backend learners.",
      features: [
        "Complete backend question library",
        "Advanced progress analytics",
        "Unlimited practice assignments",
        "Real-world scenario questions",
        "Instant code feedback system",
        "API and database practice modules",
    ...
    },
    {
      ...
      features: [
        ...
        "Priority feature requests and SLA guarantees",
      ],
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          ...
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Choose a plan that fits your backend learning goals, from individuals starting out to <br /> growing
            professionals and large organizations.
          </p>
        </div>
        <div className="pt-4">
